...
namespace Homework_10_Tumakov
{
    class BankAccount : IDisposable
    {
        ...
        internal BankAccount(decimal balance, BankAccountType type, Guid accountNumber)
        {
        ...
        internal BankAccount(decimal balance, Guid accountNumber)
        {
            this.accountNumber = accountNumber;
            this.balance = balance;
        }
        ...
        /// </summary>
        /// <param name="type">Тип банковского счета.</param>
        internal BankAccount(BankAccountType type, Guid accountNumber)
        {
            this.accountNumber = accountNumber;
            accountType = type;
        }
        ...
        /// </summary>
        internal BankAccount(Guid accountNumber)
        {
            this.accountNumber = accountNumber;
            this.balance = 0;
        ...
        {
            return $"Аккаунт ID: {accountNumber} Balance: {balance}";
        }
